...
export type MockSaju = Omit<SajuResultData, "sajuRequestId">;

// 연우 씬 fallback — 실제 응답 도달 전 시각 검증용.
export const MOCK_SAJU: MockSaju = {
  ...
  pillars: [
    ...
    },
    {
      ...
      sinSals: [{ slug: "gwi_mun_gwan_sal", label: "귀문관살", hanja: "鬼門關殺" }],
      unknown: false,
    },
    {
      label: "일주",
